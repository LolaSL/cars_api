...
const HowItWorks = () => {
  return (
    <div className={`min-h-screen m-4 py-6 justify-center  items-center bg-gray-200  px-16 text-justify text-blue-800 ${globals}`}>
      ...
      <h3 className="text-2xl font-bold mb-3 mt-6"></h3>Will you check my driving record?<h3></h3>
You need a clean driving record and a valid driver’s license to drive a Budget rental car. Budget may check your driving record to confirm you meet our requirements.
