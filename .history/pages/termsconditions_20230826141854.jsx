...
<p>You can pay for your booking at the Car LOFT office. Please note that the "Payable at Desk" amount will be in the local currency of your destination.</p>
      ...
      <h3 className="text-2xl font-bold mb-3 mt-6">11. Cancellations</h3>
      <p>Free cancellation is available until 48 hours before the rental start. To cancel your booking, send an email or call our office. Please provide your booking number in all correspondence. We will send an email to confirm your cancellation.</p>
      <h3 className="text-2xl font-bold mb-3 mt-6">12. Fuel Policy</h3>
      <span>
        <ul>
          <li>- If you received the car with a full tank, it should be returned with a full tank.</li>
          <li>- If the car was not provided with a full tank, return it with the same fuel level as when received. The amount will be noted on your rental contract.</li>
        </ul>
      </span>
      <h3 className="text-2xl font-bold mb-3 mt-6">13. Fines and Violations</h3>
      <span>
        <ul>
          <li>- Parking tickets and traffic violations are the renter's responsibility to pay before returning the vehicle.</li>
          <li>- Charges for congestion or fines received after the rental will be billed to the renter, including late payment surcharges.</li>
          <li>- A local administration fee applies, in addition to fines.</li>
        </ul>
</span>
      <p>By using our car rental services, you agree to comply with these terms and conditions. For any inquiries or assistance, please contact us via email or phone.</p>
      <p>Email: [car.loft.re.n.t@gmail.com]</p>
        <p>Phone: [+972 xxxx xxx xxx]</p>
        <p>Last Updated: [08.26]</p>
