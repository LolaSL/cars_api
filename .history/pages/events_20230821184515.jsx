...
const Events = () => {
  return (
    ...
    >
      ...
      <div
        className="show__image  mb-3 mt-6 resposive shadow-md p-2"
        style={{
          borderRadius: "3%",
          overflow: "hidden",
          width: "360px",
      ...
      >
        <Image className="responsive" src="/car_show.png" alt="cars" layout="fill" objectFit="cover" />
      </div>
      <p className="text-2xl">
      ...
      >
        <Image className="responsive" src="/event.jpg" alt="cars" layout="fill" objectFit="cover" />
      </div>
      <p className="text-2xl">
