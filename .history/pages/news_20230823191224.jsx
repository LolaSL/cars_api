...
function News() {
  ...
  return (
    ...
    >
      ...
      <p className="text-2xl mt-6 mb-4">Want To Know What Happened Today In The Cars World? Find Out Now The Latest News From AUTOCAR and Car And Driver Sources.</p>
      <CustomButton
        btnType="button"
        title="Get News"
