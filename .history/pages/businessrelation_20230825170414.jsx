...
<div className={`min-h-screen m-4 py-6 justify-center  items-center bg-gray-200  px-16 text-justify text-blue-800 ${globals}`}>
      ...
      <h2>      <p className="mb-3 mt-6">
        Car Loft is the rental platform, providing a connection car rentals with
        clients. It has got leading brands that match, and connect plenty of car
