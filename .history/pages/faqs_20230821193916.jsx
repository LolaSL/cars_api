...
const Faqs = () => {
  return (
    ...
    >
      <h1 className="text-3xl font-bold mb-3 mt-6 text-center">
        {" "}
      ...
      <p className="text-2xl">
        Tel Aviv Ben Gurion International Airport, Therminal 3. Our office is 15 min drive from airport.
      </p>
      <h3 className="text-2xl font-bold mb-3 mt-6">
      ...
      <p className="text-2xl">3. Credit or Debit Card for Deposit/ Cash </p>
      ...
      <h3 className="text-2xl font-bold mb-3 mt-6">How do I pay my booking?</h3>
      <p className="text-2xl">
        {" "}
      ...
      <p className="text-2xl">
      Free cancellation until 48 hours before the start of the rental.</p>

      <p className="text-2xl">You can send us a e-mail or call our office and let us know that you will be cancelling your booking.</p>

      <p className="text-2xl">Please include your booking number in all correspondance. We will send you an e-mail back to confirm your cancellation.
      </p>
      <h3 className="text-2xl font-bold mb-3 mt-6">
        Do I have to return the car with a full tank?
      </h3>
      <p className="text-2xl">
      If you got the car with a full tank then the car should be returned with a full tank.</p>
      <p className="text-2xl">Otherwise you should return the car with the same amount of fuel as it was when you received it. The amount will be marked on your rental contract.</p>
      <h3 className="text-2xl font-bold mb-3 mt-6">
       Fines, Parking tickets, traffic violations
      </h3>
      <p className="text-2xl">
      Parking tickets and any traffic violations are the responsibility of the renter who must pay them before returning the vehicle. Congestion charges or fines received by us after the rental will be charged directly to the renter, including a surcharge for late payment, if any. A local administration fee applies: this will be charged in addition to the fines.</p>
