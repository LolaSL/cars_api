...
const blog: React.FC = () => {
  ...
  const [formSuccessComment, setFormSuccessComment] = useState("")
  ...
  const submitForm = (e) => {
    ...
    .then((data) => {
      ...
      setFormSuccess(true)
      setFormSuccessComment(data.submission_text)
    })
  }
  useEffect(() => {
      ...
      <div>
        ...
        >
          ...
          <div>
            ...
            <textarea name="message" onChange={handleInput} value={formData.comment}></textarea>
          </div>
