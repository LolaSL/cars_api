  ...
  return (
    <div className={styles.wrapper}>
      ...
      <Link
        ...
        >        Go to Other page</Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></Link></</Link>
