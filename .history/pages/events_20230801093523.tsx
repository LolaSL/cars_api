    ...
    <div className={styles.wrapper}>
      ...
      <div className="car_show">
        ...
        <div className="show__image-overlay"></div>
          ...
          <p>2024 marks the 9th annual London Classic Car Show. More than 700 stunning classic cars will be on display alongside a feast of additional attractions to entertain and inspire show-goers of all ages. From vintage Formula 1 racing cars to American muscle cars, it's the undeniable event of the season for the UK's car enthusiasts.</p>
