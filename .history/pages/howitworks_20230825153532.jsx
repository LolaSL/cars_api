...
const HowItWorks = () => {
  return (
    ...
    >
      ...
      <p>We make it easy for you your search of rental cars. The search will make an acquanteince with our cars - and our search results page tells you how many of them might be right for you, based on what you’ve told us.
