...
function News() {
  ...
  const url = `https://newsapi.org/v2/everything?domains=autocar.co.uk,autoblog.com&pageSize=12&page=10&apiKey=640e78c8d6d7466faf6e27fcfe8102ec`;
  ...
  return (
    ...
    >
      ...
      <ShowMore
  pageNumber={Math.ceil((data?.articles.length || 0) / 12)}
  isNext={((data?.articles.length || 0) / 12) > 1}
/>
