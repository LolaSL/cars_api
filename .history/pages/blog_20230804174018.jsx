...
const Blog = () => {
  ...
  return (
    <div className={min-h-screen flex justify-center items-center bg-gray-200 my-10 px-16 text-justify text-blue-800 scroll-snap-y-mandatory scroll-padding-y-10 overflow-y-scroll;}>
      <h1>BLOG</h1>
