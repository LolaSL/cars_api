...
const SignUp = () => {
  ...
  try{  const handleSubmit: FormEventHandler<HTMLFormElement> = async (e) => {
    setBusy(true)
    e.preventDefault();
    ...
    const jsonData = await res.json(); // Parse JSON data
  ...
  return (
    ...
    <div className="min-h-screen m-4 py-6 justify-center  items-center bg-gray-200  px-16 text-justify text-blue-800">
      ...
      <div className="link text-md font-bold  mb-4 mt-14">
        ...
        <Link href="/signin" style={{ color: "blue", textDecoration: "none" }}>
          {" "}
          Sing In
        </Link>
      </div>
