...
const Blog = () => {
  return (
    <div className="min-h-screen m-4 py-6 justify-center  items-center bg-gray-200  px-16 text-justify text-blue-800">
      ...
      <div>
        <p className="font-lighter font-italic mb-3 mt-6">
          <i></i>If you want to leave a feedback to this post or to some other users
          comment, simply fill out the form here
        </p>
      </div>
