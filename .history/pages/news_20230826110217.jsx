...
function News() {
  ...
  const url = `https://newsapi.org/v2/everything?domains=autocar.co.uk,techxplore.com,https://www.techradar.com/&pageSize=32&apiKey=640e78c8d6d7466faf6e27fcfe8102ec`;
  ...
  return (
    ...
    >
      ...
      <p className="text-2xl mt-6 mb-6">
        ...
        Latest News and Videos From AUTOCAR and TECHXPLORE Sources. Just Be
        Updated
      </p>
      <CustomButton
        btnType="button"
