...
const HowItWorks = () => {
  return (
    ...
    >
      ...
      <h3 className="text-2xl  mb-3 mt-6">
      How does our service work?
      </h3>
      <p>
        We make it easy for you your search of rental cars. And our search
        results page tells you how many of them might be right for you, based on
        what you’ve told us. <p>When you book your car, you enter into a contract
        with us: we’re agreeing to arrange and manage* your Booking.</p>When you book your car, you enter into a contract
        with us: we’re agreeing to arrange and manage* your Booking. When you
        sign your Rental Agreement at the counter, you enter into a contract
        with Cars Loft:we are agreeing to provide the car. You’ll already have
        seen and accepted all the key terms (while you were booking the car). *
        We’re here for you if you need to change or cancel your Booking, or if
        you have any questions – before, during or after your rental.
      </p>
      <h3 className="text-2xl  mb-3 mt-6">
