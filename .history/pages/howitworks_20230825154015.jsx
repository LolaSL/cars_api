  ...
  return (
    ...
    >
      ...
      <p>
        ...
        with us: we’re agreeing to arrange and manage* your Booking.</p> When you
        ...
        seen and accepted all the key terms (while you were booking the car). *</p>
       <p> We’re here for you if you need to change or cancel your Booking, or if
