...
<div className={`min-h-screen m-4 py-6 justify-center  items-center bg-gray-200  px-16 text-justify text-blue-800 ${globals}`}>
        ...
        <h3 className="text-2xl font-bold mb-3 mt-6">1. Information We Collect</h3>
        ...
        <ul>
          ...
          <li>Payment Information: We may collect credit or debit card details for deposit purposes or accept cash payments.</li>
          <li>Driving Record: We require a clean driving record and may check your driving history to ensure you meet our requirements.</li>
        </ul>
        </span>
        <h3 className="text-2xl font-bold mb-3 mt-6">3. Data Sharing

</h3>
        <span className=" mb-3 mt-6">
          <p>We may share your information with the following parties:</p>
        <ul>
          <li>Rental Locations: Your information may be shared with our branch locations to fulfill your rental request.</li>
          <li>Legal Compliance: We may disclose your information to comply with legal obligations or respond to legal requests.</li>
          <li></li>
          </ul>
      </span>
        <h3 className="text-2xl font-bold mb-3 mt-6">4. Data Security</h3>
        <p className="mb-3 mt-6">
        We implement security measures to protect your information from unauthorized access, alteration, or disclosure. However, no method of transmission over the internet or electronic storage is completely secure, and we cannot guarantee absolute security.
        </p>
