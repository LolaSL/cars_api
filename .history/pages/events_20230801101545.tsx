  ...
  return (
    <div className={styles.wrapper}>
      ...
      <p>
        ...
        desert Negev.The Festival is an extravaganza to
        celebrate carsport, from  classic cars right through to
        cutting-edge supercars and F1 models. Enjoy the famoust 
      ...
      >
        <Image src="/car_show1.png" alt="cars" layout="fill" objectFit="cover" />
          </div>
          <p>Dates to be confirmed for 2024 soon</p>
      ...
      >
        <Image src="/car_show2.png" alt="cars" layout="fill" objectFit="cover" />
          </div>
          <p>Start your explorations the right way with Jardine Motors Group. Our dealerships are outfitted with cutting-edge equipment operated by qualified technicians, allowing us to ensure your vehicle is well taken care of. ​

​

Let us provide peace of mind before your next adventure.</p>
    </div>
  );
};
