...
const HowItWorks = () => {
  return (
    ...
    >
      ...
      <h3 className="text-2xl  mb-3 mt-6  font-bold">How does our service work?</h3>
    ...
    <p className="mb-3 mt-6">
        ...
        contract with Cars Loft: we are agreeing to provide the car. You’ll
      ...
      <h3 className="text-2xl  mb-3 mt-6  font-bold">
      Payments
      </h3>
      <p className="mb-3 mt-6">When you book a car in our Contact Us form, we will organise your payment. </p>
