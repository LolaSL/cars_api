...
const HowItWorks = () => {
  return (
    ...
    >
      ...
      If you have any questions, or something doesn’t go according to your plan, just <Contact Us. If it’s about something that happened during your Rental, we’ll be able to help you more quickly if you provide:
