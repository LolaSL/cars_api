...
const PrivacyPolicy = () => {
  return (
    ...
    >
      ...
      <h3 className="text-2xl font-bold mb-3 mt-6">8. Changes to Privacy Policyt</h3>
      <span className=" mb-3 mt-6">
      <p>We may update this Privacy Policy to reflect changes in our practices or legal requirements. We encourage you to review this policy periodically.</p>
