...
<div className={`min-h-screen m-4 py-6 justify-center  items-center bg-gray-200  px-16 text-justify text-blue-800 ${globals}`}>
  ...
  <p ><em>These Terms and Conditions govern the use of Car LOFT's car rental services. By using our services, you agree to abide by these terms. Please read them carefully before making a reservation.</em></p>
