...
const Faqs = () => {
  return (
    ...
    >
      ...
      <p className="text-2xl">
        4. Fuel isn’t included in the cost of your rental.
      </p>
      <h3 className="text-2xl font-bold mb-3 mt-6">
      ...
      <p className="text-2xl">
        ...
        Car LOFT allows up to two additional drivers per rental.
          ...
          <h3>What happens if I return my car rental early?</h3>
          <p>If you return you vehicle earlier than expected then no refund applies.</p>
          <h3>Do you offer one-way car rentals?</h3>
          <p>Yes, you can rent a car and drive one-way between most of our branch locations, subject to availability.</p>
