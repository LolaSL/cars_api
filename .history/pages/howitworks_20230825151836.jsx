  ...
  return (
    ...
    >
      ...
      <p className="text-2xl">
        If you have any questions, or something doesn’t go according to your plan, just <strong>Contact Us</strong>.
        If it’s about something that happened during your rental, we’ll be able to help you more quickly if you provide:
        <ol>
          <li>your Booking reference number, and the email address you used when you booked your car</li>
          <li>a summary of the issue, including how you’d like us to help you

details of anything you’ve been charged</li>
          <li>any supporting documents (bank statement, rental agreement, final invoice, damage documentation, photos, boarding pass, receipts, etc.).</li>
