...
const Podcast = () => {
  return (
    <div className="min-h-screen m-4 py-6 justify-center  items-center bg-gray-200  px-16 text-justify text-blue-800">
      ...
      <h2 className="text-2xl font-bold mb-3 mt-6"> Automotive Podcasts You Should Be Listening to Right Now</h2>
      <div
        className="show__image  mb-3 mt-6 resposive shadow-lg"
        style={{
          borderRadius: "3%",
          overflow: "hidden",
          width: "300px",
      ...
      <h3 className="text-xl font-bold  mb-3 mt-6">Car Talk</h3>
      <p>
      ...
      <h3 className="text-xl font-bold  mb-3 mt-6">Car Stuff</h3>
      <p>
      ...
      <h3 className="text-xl font-bold  mb-3 mt-6">The Smoking Tire</h3>
      <p>
