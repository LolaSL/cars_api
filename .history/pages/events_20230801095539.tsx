    ...
    <div className={styles.wrapper}>
      ...
      <h3>Car LOFT CLASSIC CAR SHOW</h3>
        <div className='show__image'   style={{
          borderRadius: '3%', /* Apply circular border radius */
          overflow: 'hidden',
          width: '370px', /* Adjust the image container width as needed */
          height: '200px', /* Adjust the image container height as needed */
