      ...
      data.articles.map((d, index) => {
        return (
          <div key={index}>
            ...
            <div>{d.title}</div>
            <div> <Link href={d.url} target="_blank" rel="noopener noreferrer" className="pl-3">Article</Link></div>
            <div>    <Link href={d.urlToImage} target="_blank" rel="noopener noreferrer">Image</Link></div>
