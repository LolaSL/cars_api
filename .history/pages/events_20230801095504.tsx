  ...
  return (
    <div className={styles.wrapper}>
      ...
      <h3>Car LOFT CLASSIC CAR SHOW</h3>
        <div className='show__image'   style={{
          borderRadius: '5%', /* Apply circular border radius */
          overflow: 'hidden',
          width: '400px', /* Adjust the image container width as needed */
          height: '300px', /* Adjust the image container height as needed */
          position: 'relative' /* Set position to relative to align the image properly */
        }}>
                  <Image
          ...
          <p>2024 marks the 1 annual Car LOFT Car Show. More than 150 stunning classic cars will be on display alongside a feast of additional attractions to entertain and inspire show-goers of all ages. From 2013 cars to the last 2023 cars, it's the undeniable event of the season for the car enthusiasts.</p>
