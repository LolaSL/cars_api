...
const Blog = () => {
  ...
  return (
    <div className="min-h-screen m-8 justify-center  items-center bg-gray-200 my-10 px-16 text-justify text-blue-800">
      ...
      <h3 className="text-2xl font-bold mb-3 mt-6">Driveability vs. Authenticity</h3>
      <p>
...
<h3 className="text-2xl font-bold  mb-3 mt-6">Set Your Expectations</h3>
      ...
      <div >
        <h3 className="text-2xl font-bold  mb-3 mt-6">Leave a comment</h3>
        <p>
      ...
      <div className="link className="text-2xl font-bold  mb-3 mt-6"">
          <Link
          id="link"
          href="/"
