...
const Faqs = () => {
  return (
    ...
    >
      ...
      <p className="mb-3 mt-6">1. An ID card/passport</p>
      <p className="mb-3 mt-6">2. Valid Driver’s License</p>
      <p className="mb-3 mt-6">3. Credit or Debit Card for Deposit/ Cash </p>
      <p className="mb-3 mt-6">4. Clean Driving Record</p>
      <p className="mb-3 mt-6">
      ...
      <h3 className="text-2xl font-bold mb-3 mt-6">Cancellations?</h3>
      <p className="mb-3 mt-6">
      ...
      <div className="link  font-bold  mb-3 mt-6">
        ...
        <div className="link text-2xl font-bold  mb-3 mt-6">
