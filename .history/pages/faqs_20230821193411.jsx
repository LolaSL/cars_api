...
const Faqs = () => {
  return (
    ...
    >
      ...
      <p className="text-2xl">Otherwise you should return the car with the same amount of fuel as it was when you received it. The amount will be marked on your rental contract.<
