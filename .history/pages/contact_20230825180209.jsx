  ...
  return (
    ...
    >
      ...
      <p className="mb-3 mt-6">
        It is no longer a dream. Anyone can rent a luxury car from our variety
        of luxury vehicles on offer, for any purpose: a business meeting, VIP
        ...
        international artists, VIP treatments, pick-ups from the airport, etc
      </p>
      <span className="font-bold font-size-">
