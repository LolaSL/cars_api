...
const TermsAndConditions = () => {
  return (
    ...
    >
      ...
      <p>
        You agree to use the Website in a lawful and responsible manner. You
        must not:
      </p>
      <ul className="mb-3 mt-6">
        ...
        <li>
          Post or transmit any content that is offensive, harmful, or violates
        ...
        <li>
          Engage in any activity that disrupts or negatively impacts the
      ...
      <p>
        The content, design, and other materials on the Website are protected by
      ...
      <p>
        ...
        or control the content of these websites and are not responsible for
        their practices. Your use of third-party sites is subject to their terms
        and conditions.
      </p>
