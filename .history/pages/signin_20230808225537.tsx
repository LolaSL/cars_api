...
const SignIn = () => {
  ...
  const [error, setError] = useState<string | undefined>(); // Specify the type for the error state
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = async (e) => {
    ...
    if (res?.error) setError(res.error); // Set error state correctly
