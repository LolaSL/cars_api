...
function News() {
  ...
  const url = `https://newsapi.org/v2/everything?domains=autocar.co.uk,autoblog.com&&apiKey=640e78c8d6d7466faf6e27fcfe8102ec`;
  
  const fetchMoreArticles = () => {
    const nextPage = currentPage + 1;
    const newUrl = `https://newsapi.org/v2/everything?domains=autocar.co.uk,autoblog.com&page=${nextPage}&apiKey=640e78c8d6d7466faf6e27fcfe8102ec`;
...
<ShowMore
  ...
  isNext={(currentPage * 12) < (articles.length || 0)} // Adjust this condition based on your API's total results count
