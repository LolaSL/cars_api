...
const FA = () => {
  return (
    <div className={`min-h-screen m-4 py-6 justify-center  items-center bg-gray-200  px-16 text-justify text-blue-800 ${globals}`}>
        <h1 className="text-3xl font-bold mb-3 mt-6"> Frequently Asked Questions</h1>
      ...
      <p className="text-2xl" >4. Fuel isn’t included in the cost of your rental.</p>
      <h3 className="text-2xl font-bold mb-3 mt-6">Will you check my driving record?</h3>
      <p className="text-2xl" >You need a clean driving record and a valid driver’s license to drive a  Car LOFT rental car.
        Car LOFT may check your driving record to confirm you meet our requirements.</p>
        <h3 className="text-2xl font-bold mb-3 mt-6">Is smoking permitted in rental cars?</h3>
        <p className="text-2xl">No. Car LOFT maintains a 100%
        smoke-free fleet in the U.S. and Canada, and any type of smoking (pipe,
        cigarette, cigar) is prohibited in all  Car LOFT vehicles. Just as renters
        ...
        assessed an additional charge if the car smells of smoke when it is
          returned.</p>
          <p className="text-2xl">Rent a  Car LOFT car and breathe easy — because our stringent
        ...
        on  Car LOFT for a clean, well-maintained, fresh-smelling vehicle? </p>
        <h3 className="text-2xl font-bold mb-3 mt-6">Additional Drivers</h3>
        <p className="text-2xl"> Car LOFT allows up to two additional drivers per rental.</p>
