...
const Faqs = () => {
  return (
    ...
    >
      ...
      <p className="text-2xl">
        {" "}
              You can pay at office of Car LOFT.
              Keep in mind that when you will pick up the car the 'Payable at Desk' amount will be in the local currency of your destination.
          </p>
          <h3 className="text-2xl font-bold mb-3 mt-6">When will my deposit be released?</h3>
      <p className="text-2xl">
        {" "}
        Once you return the car back without a damage, the deposit/guarantee amount will be released/ refunded to your credit card. This transaction usually takes from 7 to 21 working days to appear. Contact your bank first in order to check it.
          </p>
