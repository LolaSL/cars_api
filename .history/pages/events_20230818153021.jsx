...
const Events = () => {
  ...
  return (
       ...
       <h3 className="text-2xl font-bold mb-3 mt-6">Biggest Car LOFT Shows and Events for 2024 year</h3>
      ...
      <h3 className="text-2xl font-bold mb-3 mt-6">Car LOFT CLASSIC CAR SHOW</h3>
      <div
    ...
    >
     ...
     >
      ...
      <p className="text-2xl">
        ...
        care of. <p></p><i>Let us provide peace of mind before your next adventure.</i>
      </p>
