...
const HowItWorks = () => {
  return (
    <div className={`min-h-screen m-4 py-6 justify-center  items-center bg-gray-200  px-16 text-justify text-blue-800 ${globals}`}>
      ...
      <Will className="text-2xl font-bold mb-3 mt-6">Will you check my driving record?</h3>
      <p className="text-2xl" >You need a clean driving record and a valid driver’s license to drive a Budget rental car.
        Budget may check your driving record to confirm you meet our requirements.</p>
        ...
        on Budget for a clean, well-maintained, fresh-smelling vehicle? </p>Additional Drivers
Budget allows up to two additional drivers per rental.
