...
const HowItWorks = () => {
  return (
    <div className={`min-h-screen m-4 py-6 justify-center  items-center bg-gray-200  px-16 text-justify text-blue-800 ${globals}`}>
      ...
      <p className="text-2xl" ></p>You need a clean driving record and a valid driver’s license to drive a Budget rental car. Budget may check your driving record to confirm you meet our requirements.
