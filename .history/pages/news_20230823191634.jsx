...
function News() {
  ...
  return (
    ...
    >
      ...
      <p className="text-2xl mt-6 mb-4">Want To Know What Happened Today In The Cars World? Find Out Now The Latest News and Videos From AUTOCAR and Car And Driver Sources. Just Be Updated</p>
      <CustomButton
        btnType="button"
        title="Get News"
