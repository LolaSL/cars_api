...
const Blog = () => {
  ...
  return (
    <div className="min-h-screen m-8 justify-center  items-center bg-gray-200 my-10 px-16 text-justify text-blue-800">
      <h1 className="text-3xl font-bold mt-10 mb-10">BLOG</h1>
      ...
      <h3 className="text-2xl font-bold">Driveability vs. Authenticity</h3>
      <p>
      ...
      <h3 className="text-2xl font-bold">Walking the Line</h3>
        <p>
