...
const Businessrelationship: React.FC = () => {
  ...
  return (
    <div>
      ...
      <h3>Partnership</h3>
<p>Extremely similar to a sole proprietorship, this option allows individuals to join or contribute to the funding of your car rental business at any stage in your company formation.</p>
