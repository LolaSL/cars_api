    ...
    <><div className="min-h-screen m-4 py-6 justify-center  items-center bg-gray-200  px-16 text-justify text-blue-800">
      ...
      <div
        ...
        style={{
          ...
          padding: "30px",
          box
        } - shadow} />: "2px -1px 10px 2px #ebe5e5, -2px 2px 15px 2px #ebe5e5"
      }}
      >
      <Image src="/car_show.png" alt="cars" layout="fill" objectFit="cover" />
        ...
        the car enthusiasts.
      </p><p>Dates to be confirmed for 2024 soon</p><h3 className="text-xl font-bold mb-3 mt-6">Desert FESTIVAL OF SPEED</h3><p>
      ...
      >
        <Image
          ...
          layout="fill"
          objectFit="cover" />
      </div><p>Dates to be confirmed for 2024 soon</p><div
      ...
      </p><div className="link text-md font-bold  mb-3 mt-6">
        <Link
          href="/"
