...
const Events: React.FC = () => {
  ...
  return (
      <div className={styles.wrapper}>
          ...
          <h1>Events</h1>
          <h2> 3 Biggest Car LoShows and Events for 2023</h2>
     ...
     <p> Explore the 3 biggest and best car shows and festivals around the world in 2023, including racing highlights.</p>
      </div>
  )
}
