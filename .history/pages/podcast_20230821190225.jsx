...
const Podcast = () => {
  return (
    <div className={`min-h-screen m-4 py-6 justify-center  items-center bg-gray-200  px-16 text-justify text-blue-800 ${globals}`}>
       <h1 className="text-3xl font-bold mb-3 mt-6 text-center">Podcast</h1>
      <h3 className="text-2xl font-bold mb-3 mt-6"> Automotive Podcasts You Should Be Listening to Right Now</h3>
      ...
      <h3 className="text-2xl font-bold  mb-3 mt-6">Car Talk</h3>
      <p className="text-2xl">
      ...
      <h3 className="text-2xl font-bold  mb-3 mt-6">Car Stuff</h3>
      <p className="text-2xl">
      ...
      <h3 className="text-2xl font-bold  mb-3 mt-6">The Smoking Tire</h3>
      <p className="text-2xl">
        ...
        The Smoking Tire is no holds barred.
          ...
          <h3 className="text-2xl font-bold  mb-3 mt-6">Everyday Driver</h3>
          <p className="text-2xl">If you like your pods to have a little friction between hosts, then Everyday Driver is the automotive podcast for you. Paul and Todd answer listening questions each episode to help people find the right car for them. Disagreements abound. These guys will also keep you up to date about industry news and review auto-related films. It’s a fun time. Episodes are usually about an hour long, and they put out more than a podcast a week.</p>
