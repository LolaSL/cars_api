  ...
  return (
    <div className={`${globals}`}>
      ...
      >
        ...
        <span>
          We use your personal information to: <p>- Provide and improve our
          services </p>- <p>espond to your inquiries and provide customer support</p>R -
          <p></p>Send you updates, newsletters, and promotional content (with your
          consent) - <p></p>Analyze website traffic and usage patterns - <p></p>Ensure
        ...
        <p>Changes to this Privacy Policy We may update this Privacy Policy from
