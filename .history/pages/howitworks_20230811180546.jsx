    ...
    <div>
      {/* <div
        ...
        style={{
          ...
          height: "120vh",
          opacity: 0.6,
          backgroundImage: `url("https://www.vecteezy.com/video/9859380-silver-cinematic-coming-soon-title-animation")`,
      ...
      <div className="video-container">
        <video autoPlay muted loop className="video">
          <source src="https://www.vecteezy.com/video/9859380-silver-cinematic-coming-soon-title-animation" type="video/mp4" />
        ...
        <h2 className="text-2xl font-bold mb-3 mt-6">Coming soon</h2>
        <p>
